...
to_bf16_cuda_t ggml_get_to_bf16_cuda(ggml_type type) {
    switch (type) {
        ...
        case GGML_TYPE_SNC4:
            return dequantize_block_cont_cuda<QK_SNC4, QR_SNC4, dequantize_snc4>;
        case GGML_TYPE_SNC8:
            return dequantize_block_cont_cuda<QK_SNC8, QR_SNC8, dequantize_snc8>;
        case GGML_TYPE_F32:
...
to_fp16_nc_cuda_t ggml_get_to_fp16_nc_cuda(ggml_type type) {
    switch (type) {
        ...
        case GGML_TYPE_SNC4:
            return dequantize_block_cuda<QK_SNC4, QR_SNC4, dequantize_snc4>;
        case GGML_TYPE_SNC8:
            return dequantize_block_cuda<QK_SNC8, QR_SNC8, dequantize_snc8>;
        case GGML_TYPE_IQ4_NL:
