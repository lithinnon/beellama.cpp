...
#define DECL_FATTN_VEC_SNC_CASES(D) \
    extern DECL_FATTN_VEC_CASE(D, GGML_TYPE_SNC4, GGML_TYPE_SNC4); \
    extern DECL_FATTN_VEC_CASE(D, GGML_TYPE_SNC8, GGML_TYPE_SNC8); \
    extern DECL_FATTN_VEC_CASE(D, GGML_TYPE_SNC4, GGML_TYPE_SNC8); \
    extern DECL_FATTN_VEC_CASE(D, GGML_TYPE_SNC8, GGML_TYPE_SNC4); \
    extern DECL_FATTN_VEC_CASE(D, GGML_TYPE_SNC4, GGML_TYPE_F16);  \
    extern DECL_FATTN_VEC_CASE(D, GGML_TYPE_SNC8, GGML_TYPE_F16);  \
    extern DECL_FATTN_VEC_CASE(D, GGML_TYPE_F16,  GGML_TYPE_SNC4); \
    extern DECL_FATTN_VEC_CASE(D, GGML_TYPE_F16,  GGML_TYPE_SNC8); \
    extern DECL_FATTN_VEC_CASE(D, GGML_TYPE_SNC4, GGML_TYPE_BF16); \
    extern DECL_FATTN_VEC_CASE(D, GGML_TYPE_SNC8, GGML_TYPE_BF16); \
    extern DECL_FATTN_VEC_CASE(D, GGML_TYPE_BF16, GGML_TYPE_SNC4); \
    extern DECL_FATTN_VEC_CASE(D, GGML_TYPE_BF16, GGML_TYPE_SNC8);

DECL_FATTN_VEC_SNC_CASES( 64)
DECL_FATTN_VEC_SNC_CASES(128)
DECL_FATTN_VEC_SNC_CASES(256)
DECL_FATTN_VEC_SNC_CASES(512)
