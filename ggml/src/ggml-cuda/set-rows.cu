...
#define LAUNCH_CASE(type, block_type, qk, quantize_func) \
    ...
    switch (body->type) {
        ...
        LAUNCH_CASE(GGML_TYPE_SNC4,  block_snc4,   QK_SNC4, quantize_f32_snc4_block);
        LAUNCH_CASE(GGML_TYPE_SNC8,  block_snc8,   QK_SNC8, quantize_f32_snc8_block);
        default:
...
static void set_rows_cuda(ggml_backend_cuda_context & ctx, const ggml_tensor * src0, const ggml_tensor * src1, ggml_tensor * dst) {
    ...
    } else if (dst->type == GGML_TYPE_SNC4) {
        set_rows_cuda_quant<idx_t, block_snc4, QK_SNC4, quantize_f32_snc4_block>(
            src0_d, src1_d, (block_snc4*)dst->data,
            ne00, ne01, ne02, ne03,
            ne10, ne11, ne12, ne13,
            nb01, nb02, nb03,
            nb10, nb11, nb12,
    ...
    } else if (dst->type == GGML_TYPE_SNC8) {
        set_rows_cuda_quant<idx_t, block_snc8, QK_SNC8, quantize_f32_snc8_block>(
            src0_d, src1_d, (block_snc8*)dst->data,
            ne00, ne01, ne02, ne03,
            ne10, ne11, ne12, ne13,
            nb01, nb02, nb03,
            nb10, nb11, nb12,
