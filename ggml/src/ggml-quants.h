...
GGML_API void quantize_row_snc4_ref(const float * GGML_RESTRICT x, block_snc4 * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_row_snc8_ref(const float * GGML_RESTRICT x, block_snc8 * GGML_RESTRICT y, int64_t k);
...
GGML_API void dequantize_row_snc4(const block_snc4 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_snc8(const block_snc8 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
...
GGML_API void quantize_row_snc4(const float * GGML_RESTRICT x, void * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_row_snc8(const float * GGML_RESTRICT x, void * GGML_RESTRICT y, int64_t k);
GGML_API size_t quantize_snc4(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_snc8(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
